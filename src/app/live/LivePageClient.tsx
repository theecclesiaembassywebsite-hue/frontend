...
export default function LivePageClient() {
  ...
  return (
    <div className="w-full">
      {/* The page opens straight into the player with no visible title —
          this keeps a real, unique <h1> for accessibility/SEO without
          disturbing that video-first layout. */}
      <h1 className="sr-only">Livestream — The Ecclesia Embassy</h1>
      {activeStream ? (
